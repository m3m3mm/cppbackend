...
namespace {
    ...
    json::value MakeBodyPlayers(const std::vector<std::shared_ptr<Dog>>& dogs) {
        json::object result;
    ...
    json::value MakeBodyStatePlayers(const std::vector<std::shared_ptr<Dog>>& dogs) {
        json::object result;
...
string MakeBodyJSON(TargetRequestType req_type, const std::vector<std::shared_ptr<Dog>>& dogs) {
    switch (req_type) {

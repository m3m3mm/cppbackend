...
public:
    ...
    CoordUnit Clamp (CoordUnit new_pos) const;
    ...
    bool IsCurrectPos(CoordUnit pos) const;
...
public:
    ...
    const Map::Roads FindCandidateRoads(CoordUnit coord_position) const;
...
public:
    ...
    void Move(CoordUnit coord) const;
